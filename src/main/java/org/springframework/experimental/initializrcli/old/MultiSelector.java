...
public class MultiSelector {
	...
	// private int projectionStart = 0;
	// private int projectionLength = 5;
	...
	public MultiSelector(Terminal terminal, String title, Collection<String> options) {
	...
	public List<String> select() {
		...
		try {
			...
			display.clear();
			display.reset();
			AtomicInteger selectRow = new AtomicInteger(0);
